...
function Bubbles(container, self, options) {
  ...
  widerBy = options.widerBy || 2 // a little extra width to bubbles to make sure they don't break
...
// function to add all HTML and CSS necessary for chat-bubble to function
